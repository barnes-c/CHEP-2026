...
\author{\firstname{Christopher} \lastname{Barnes}\orcidlink{0009-0003-1963-7992}\inst{1}\fnsep\thanks{\email{christopher.barnes@cern.ch}} \and
        \firstname{Daniel} \lastname{Juárez}\orcidlink{0000-0000-0000-0000}\inst{1}\fnsep\thanks{\email{daniel.juarez.gonzalez@cern.ch}} \and
        \firstname{Luis} \lastname{Fernández Álvarez}\orcidlink{0000-0000-0000-0000}\inst{1}\fnsep\thanks{\email{luis.fernandez.alvarez@cern.ch}} \and
        \firstname{Giacomo} \lastname{Tenaglia}\orcidlink{0000-0000-0000-0000}\inst{1}\fnsep\thanks{\email{giacomo.tenaglia@cern.ch}}
}
